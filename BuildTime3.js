...
function cercalavoro(jobs, position, location) {
  let result = []
  for (let job of jobs) {
    if (job.location.toLowerCase().includes(location.toLowerCase()) && job.position.toLowerCase().includes(position.toLowerCase)) {
...
console.log(cercalavoro(jobs,"dev", "us"));
